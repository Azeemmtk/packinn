              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      '4.5', // Placeholder rating, replace with actual data if available
                ...
                Row(
                  children: [
                    ...
                    width5,
                    Text(
                      '(3 KM)', // Placeholder distance, replace with calculated distance
                      style: TextStyle(
                ...
                Text(
                  'RENT - ${hostel.rooms.isNotEmpty ? hostel.rooms[0]['price'] ?? 'N/A' : 'N/A'} /MONTH',
                  style: const TextStyle(
                    color: Colors.green,
